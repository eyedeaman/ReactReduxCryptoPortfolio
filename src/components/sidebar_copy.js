                ...
                {coins.map(function(coin){
                    ...
                    return (
                        ...
                        >
                            ...
                            {/* Coin image */}
                            <div><img src={coin.image} height={30} style={{borderRadius:50, marginRight:10}}/></div>
                            ...
                            <div className="coin_right">
                                ...
                                <span>
                                    {displayInBTC ? 
                                    // If dispalyInBTC is true show BTC value
                                    <span>{_.round(coin.currentPriceBTC,2)} BTC</span>
                                    : 
                                    // If displayInBTC is false show USD value
                                    <CurrencyFormat 
                                ...
                                <span>
                                    ...
                                    <span style={{
                                        color: coin.btcPctChange24Hour < 0 ? '#ff6666' : '#66cc66' //text is green if > 0
                                    }}>{_.round(coin.btcPctChange24Hour)}%</span>
                                    : 
                                    // If displayInBTC is false show USD %
                                    <span style={{
                                        color: coin.usdPctChange24Hour < 0 ? '#ff6666' : '#66cc66' //text is green if > 0
                                    }}>{_.round(coin.usdPctChange24Hour)}%</span>
                                    }    
                                </span>
                            </div>
                        </div>
...
export default connect(mapStateToProps, { fetchCoins, fetchCoinDetails })(Sidebar);
